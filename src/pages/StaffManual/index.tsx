...
function StaffManual() {
  return (
    <>
      ...
      <span className="handbook-horizontal-separator"></span>
      </header>
        ...
        <main className="handbook-content">
          ...
          <section id="handbok-arbeidstid">
            ...
            <article>
              ...
              <p>It is often the case that the project you are on wants you to take the holiday at certain times,
                typically the joint holiday, Easter, Christmas, autumn/winter holiday overlapping with
                school/kindergarten, etc. We try to adapt to this, but understand that it is not always doable.</p>
              ...
              <p>We follow the Norwegian legislation and Tekna'a definition of Norwegian holidays. For instance, Christmas
                Eve and New Year's Eve are ordinary working days.</p>
            </article>
          </section>

          <section id="handbok-arbeidssted">
            <h3>Workplace</h3>
            ...
            <p>Kodeworks will cover travel expenses for assignments that entail greater costs and a significantly longer
              journey than to a normal workplace.</p>

            <p>For example, this will be with longer assignments outside zone A in Trondheim or zone 1 in Oslo.</p>
          </section>

          <section id="handbok-betingelser">
            <h3>Conditions</h3>
            ...
            <article>
              <h4>Salary</h4>
              <p>At Kodeworks, we do not want the salary to be a factor you have to think about. At the same time, it is
                important to have a good salary in order to have the freedom and stability we want all our employees to
                have. Therefore, have no individual salary assessments. As an employee, you should not have to ask for
                what you deserve. It should come automatically. We have chosen a salary model that gives everyone equal
                pay mainly based on the number of years of experience. All Kodeworks employees have an overview of what
                the others earn. An overview of the current salary level and background figures for salary adjustment
                can be found in the "Lønn" folder on Google Drive.</p>

              <p>Salary is usually paid on the 22nd of each month, or the last business day before if the 22nd is not a
                business day.</p>
            </article>
            ...
            <article>
              ...
              <p>Holiday pay is paid in June. All 25 vacation days will be deducted this month. June usually does not have
                25 working days, so the remaining vacation days are deducted correspondingly from the holiday pay.
                Employees who have started working during the current year will not have any accrued holiday pay, and
                will be deducted the remainder of the vacation day deduction in the following month (so that there will
                be a 25-day deduction in total). If you want to be paid the holiday pay at another time, this can be
                done by agreement with the accounting department. For practical reasons, it is a good idea to notify
                this in good time before you want payment.</p>
            </article>

            <article>
              <h4>Overtime and Overtime Allowance</h4>
            ...
            <article>
              ...
              <p>If you need software to do your job, such as IDEA, you can buy this directly and register an expense in
                our accounting system.</p>
            </article>

            <article>
              <h4>Literature and Other Learning Materials</h4>
              <p>There are countless sources to help quench the thirst for knowledge. If you want to take advantage of
                e-learning offers such as Pluralsight, Coursera or similar, just sign up for this. You are also free to
                buy books in all shapes and forms. After all, it is knowledge we live by! Register the expense in our
                accounting system, so that you can be reimbursed.</p>
            </article>

            <article>
              <h4>Courses and Conferences</h4>
            ...
            <article>
              <h3>Health</h3>
              <p>Our occupational group is very exposed to stress-related injuries, which can be avoided by facilitating a
                good physical work environment. If you're working from a customers offices, and feel that – for example
                – a table, screen or chair is not good enough, we will make sure to improve this. It should not be
                necessary to let such things go at the expense of health.</p>
          ...
          <section id="handbok-timeforing">
            <h3>Timekeeping</h3>
            <p>Timekeeping is unfortunately required in most consulting companies, and Kodeworks is no exception.
              Fortunately, like most other consulting companies, we have created our own timekeeping tool to make the
              process easier. In the timekeeping tool, you enter work-related time, i.e. billable time on various
              projects, illness, vacation, leave, etc. The hours are delivered by the last working day of the month.</p>
            <p>A working day in the timekeeping tool is 8 hours. This means that holidays, welfare leave and internal
              initiatives must be taken with 8 hours per day. For customer projects, it will usually be 7.5 hours, unless
              the contract indicates that we invoice the lunch break as well. You will be informed of this before the
              project starts.</p>
          ...
          <section id="handbok-other">
            <h3>Everything Else + The Office</h3>
          ...
          <section id="handbok-militaer">
            <h3>Military Service</h3>
            <p>Summons to military service, including first-time service, which requires leave from work, is notified to the
              human resources manager and placed in the calendar. For compulsory service in the Armed Forces, the Home
              Guard, the Civil Defense and the Police Reserve, up to one month salary is paid per. years, with the
              deduction of all military supplements such as salary, unemployment benefits, etc. For voluntary service in
              the Home Guard, leave without pay is granted. First-time military service is granted unpaid leave.
              Repetition exercises that last longer than four weeks must be arranged separately.</p>
          </section>

          <section id="handbok-kommunikasjon">
            <h3>Slack and Email</h3>
            <p>Most of our daily communications are on Slack, our preferred platform. Here you'll find a relaxed vibe. This
              is where you'll find everyone if you want to initiate a social gathering, like an after work beverage, a
              game of squash, or a bit of Fortnite.</p>
          ...
          <section id="handbok-employment">
            <h3>Employment</h3>
            <p>An employment is an important investment for Kodeworks. The employees are not only the people who will
              contribute to a good working environment, they are also the actual product Kodeworks delivers. There is
              therefore a great focus on hiring skilled employees who seek and master challenges. The employees represent
              Kodeworks.</p>
          </section>

          <section id="handbok-process-and-onboarding">
            <h3>Process and Onboarding</h3>
          ...
          <section id="handbok-job-types">
            ...
            <ul>
              ...
              <li>Get new leads. Is observant when in contact with customers, and picks up signals about other projects.
                Facilitates dialogue between Kodeworks and customer. Follows their network on possible projects with
                other customers.</li>
              <li>Available at a higher hourly rate. Has a CV and profile that is sellable at hourly rates up to the upper
                tier of what the market will pay. Note that Kodeworks may have other incentives for not offering the
                consultant at a high rate; the consultant can still be considered sellable at a higher hourly rate”.</li>
            ...
            <h4>Senior</h4>
            <p>An independent and experienced consultant with high professional skills and who is able to communicate well
              with colleagues, management and customers. All the criteria for promotion to senior under listed above is
              also relevant.</p>
          ...
          <section id="handbok-resignation">
            ...
            <p>Termination must notified be in writing. The notice period is mutual for employees and employers with a
              duration of three months. It runs from the first day of the month after the termination took place unless
              otherwise agreed.</p>

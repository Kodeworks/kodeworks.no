      ...
      <section className="section-content section-content-narrow handbook-wrapper">
        <nav className="handbook-sidebar">
          ...
          <ul className="list-plain handbook-sidebar-list">
            ...
            <li><a href="#handbok-arbeidssted">Arbeidssted</a></li>
            <li><a href="#handbok-betingelser">Vilkår</a></li>
            ...
            <li><a href="#handbok-kommunikasjon">Slack og E-post</a></li>
          </ul>

          <h3>Ansettelse</h3>
          <ul className="list-plain handbook-sidebar-list">
            <li><a href="#handbok-employment">Ansettelse</a></li>
        ...
        <section className="handbook-content">
          ...
          <article id="handbok-arbeidstid">
            ...
            <p>Kontraktsfestet arbeidstid er 8 timer per dag, med en 30 minutters lunsjpause. I Kodeworks opererer vi med en kjernetid mellom 9-15, med mulighet og rom til å kunne være fleksibel under arbeidstiden. I et selskap der mennesker med kompetanse er hovedproduktet, vet vi at å jobbe tett med kollegaene våre gir det beste resultatet. Vi vet og at hverdagslivet kan by på utfordringer der man av og til må tilpasse arbeidstiden litt utenom kjernetiden.</p>
            <p>Som konsulenter må vi uansett ta høyde for at kundene våre har sin egen kjernetid, og eventuelle endringer vil kunne forekomme. Det viktigste er at man avklarer eventuelle endringer med prosjektet man er på.</p>

            <h3>Ferie</h3>

            <p>Vi har vanlig 5-ukers betalt ferie.</p>
            <p>Det er ofte tilfellet at prosjektet man er på ønsker at man tar ut ferie i enkelte tidsrom, som for eksempel fellesferien, påske, julen, høst-/vinterferie som overlapper med skole og barnehage osv. Vi prøver å tilpasse oss dette, men forstår at det ikke alltid er mulig.</p>
            ...
            <p>Vi følger arbeidsmiljølovens og Tekna sin definisjon av høytider. Det vil si at julaften og nyttårsaften anses som vanlige arbeidsdager.</p>
          </article>
          ...
          <article id="handbok-betingelser">
            ...
            <p>Vi ønsker at alle våre ansatte skal ha det godt på jobb, gjennom å tilby den nødvendige friheten, tryggheten og stabiliteten i hverdagen. Samtidig er det også viktig å tilrettelegge med de nødvendige verktøyene for at du skal kunne gjøre jobben på best mulig måte.</p>
            ...
            <p>Fra tid til annen kan det hende at man må jobbe noen timer ekstra i uken. Dette sammenfaller ofte med hektiske perioder på kundeprosjekt. Utover dette, ønsker vi å holde overtid til et absolutt minimum. Vi setter den ansattes fritid høyt, og ønsker at denne respekteres. Vi tror og at man arbeider mer effektivt dersom man får tilstrekkelig hvile. Derfor bestemmer du selv om du ønsker å jobbe overtid.</p>
            <p>Overtidsbetaling beregnes time for time, og kan regnes ut ved å dele brutto årslønn på 1950 timer og legge på 40%.</p>
            <p>Forespørsler om overtid skal alltid godkjennes av nærmeste leder først, med mindre annet er avklart på forhånd.</p>


            <h3>Pensjon og forsikring</h3>

            <p>Kodeworks setter av 7% til pensjonssparing. Dette gjelder allerede fra 0G og opp til 21G, der G er folketrygdens grunnbeløp.</p>
            <p>I tillegg til vanlig yrkesreise- og yrkesskadeforsikring, har vi og reiseforsikring for fritidsreiser som dekker deg og din nærmeste familie. Vi har og behandlingsforsikring som sikrer at du får rask og god behandling dersom noe skulle oppstå. Dette inkluderer gratis tilgang til legekonsultasjoner på mobil.</p>
            <p>Vi benytter Gjensidige for både pensjon og forsikring, slik at alle ansatte kan logge inn i Gjensidige og se forsikringsvilkår og justere risikoplan for pensjonssparing. En guide for hvordan man skaffer seg oversikt over forsikringer i Gjensidige finner man under “Forsikringer” i fellesmappen på Google Drive.</p>

            <h3>Datamaskin og programvare</h3>

            <p>Vi dekker arbeidsmaskin og programvare du behøver for å gjøre jobben din. Hva du velger er opp til deg. Vi sitter på alt fra gamingmaskiner til Dell XPS og MacBook Pro. Dersom maskinen din på et tidspunkt begynner å bli for dårlig til at du kan gjøre jobben effektivt er det på tide med en ny.</p>
            <p>Dersom du trenger tilrettelagt programvare for å gjøre jobben din, kan du bare bestille dette og føre det som utlegg i regnskapssystemet.</p>
            ...
            <p>Kodeworks oppfordrer deg til å delta på kurs og konferanser. Tidligere har vi alle dratt samlet på for eksempel JavaZone, men det er forventet at de ansattes interesser og preferanser for faglig forfriskning kan tilfredsstille best på andre steder også. Dersom du ønsker å delta på kurs eller konferanser flere ganger i året kan du gjerne det, såfremt du holder deg innenfor ditt tilegnede kurs- og konferansebudsjett.</p>
            <p>Dersom du bidrar til fellesskapet gjennom å holde kurs, foredrag og liknende vil Kodeworks også dekke utgifter til dette innen rimelighetens grenser.</p>

            <h3>Helse</h3>

            <p>Vår yrkesgruppe er utsatt for belastningsskader knyttet til å sitte for mye i ro foran datamaskinen. Dette kan motvirkes gjennom å tilrettelegge for et godt fysisk arbeidsmiljø. Dersom du arbeider fra kundes kontor, og ikke finner at for eksempel bord, stol eller skjerm ikke er tilfredsstillende, vil vi ta tak i dette. Det skal ikke ikke gå utover helsen.</p>
            <p>Vi legger også til rette for at du skal kunne være fysisk aktiv. I Trondheim har vi en bedriftsavtale med 3T. Her har flere Kodeworks-ansatte for eksempel ukentlig Squash-trening. Du trenger ikke benytte deg av dette dersom det er mer praktisk for deg å trene andre steder. Vi dekker et tilsvarende beløp med andre tilbydere i tillegg. I Oslo er det ingen spesiell bedriftsavtale, så her står man fritt til å velge treningssenter, så vil man få dekket et beløp i henhold til ansattbudsjettet.</p>
            ...
            <ul>
              ...
              <li>Å være hjemme med sykt barn klassifiseres som velferdspermisjon og trekkes ikke fra tilgjengelige egenmeldingsdager.</li>
              <li>Vi har en svært god helseforsikring som dekker mange former for behandling. Mer informasjon om hva som dekkes finnes i mappen “Forsikring” på Google Drive.</li>
            ...
            <p>Kodeworks har en rekke goder som gjør at du som ansatt kan ha en fleksibel, trygg og forutsigbar hverdag. Noen av disse godene må registreres i timeføringssystemet, slik som foreldrepermisjon og velferdspermisjon. Eventuelle utlegg man har, for eksempel knyttet til ansattbudsjettet, skal registreres i regnskapssystemet og vil utbetales ved neste lønning.</p>
            <p>Periodiske utgifter som bredbånd og treningsmedlemsskap skal registreres månedlig. Dersom det er variable kostnader, er det ditt ansvar som ansatt å sørge for at den totale kostnaden for inneværende år ikke overstiger maksbeløpet for den aktuelle utgiften. Vi vil ikke dekke utgifter som overskrider grensen i ansattbudsjettet.</p>

            <ul>
              <li>Mobiltelefon og abonnement</li>
              <li>Bredbånd dekkes inntil 500kr / mnd.</li>
              <li>Treningsmedlemsskap dekkes med inntil 500kr / mnd eller gjennom 3T abonnement i Trondheim.</li>
              <li>Andre nødvendige utgifter for å utføre arbeidet, slik som datamaskin, skjerm, mus, tastatur og lignende dekkes i henhold til satsene i ansattbudsjettet.</li>
              <li>Årlig budsjett for kurs-, konferanse og litteratur i henhold til gjeldende satser i ansattbudsjettet.</li>
            ...
            <p>For å hjelpe til med å gjøre både planlagte og uforutsette hendelser i livet litt lettere å håndtere, har Kodeworks en rekke velferdspermisjoner i tillegg til det som er påkrevd av loven.</p>
          ...
          <article id="handbok-other">
            ...
            <p>På kontorene våre har du tilgang til arbeidsplass, samt kaffe og andre forfriskninger. Du kan bruke lokalene når det passer deg, som for eksempel når du ikke har anledning til å jobbe fra kundens kontorlokaler. Det er og helt i orden å bruke kontoret på fritiden, enten det er for å arrangere LAN-party eller spise pizza. Bare sørg for å forlate kontoret i samme (helst litt bedre) stand enn da du ankom!</p>
          </article>

          <article id="handbok-militaer">
            <h2>Militærtjeneste</h2>

            <p>Innkalling til militærtjeneste som krever at man er borte fra arbeidsplassen, inkludert førstegangstjeneste, meldes fra til nærmeste leder og legges inn i kalenderen.</p>
            <p>Ansatte med fullført forutgående prøvetid vil få utbetalt lønn for inntil 1 måned i kalenderåret ved tvungen militær-tjeneste, sivil tjenesteplikt, plikttjeneste i sivilforsvaret, i politireserven og i heimevernet. Eventuelle tjenestetillegg utbetalt i forbindelse med plikttjenesten vil bli trukket fra lønnsutbetalingen.</p>
            <p>Innkallelse til førstegangstjeneste medfører permisjon uten lønn. Frivillig verv som medfører plikttjeneste utover ovennevnte 1 måned vanlig trening vil bli tilrettelagt av arbeidsgiver iht. gjeldende lovverk og gis permisjon uten lønn.</p>
          </article>

          <article id="handbok-kommunikasjon">
            <h2>Slack og E-post</h2>

            <p>Mesteparten av vår daglige kommunikasjon skjer på Slack, som er vår foretrukne plattform. Her finner du en avslappet stemning. Dette er stedet du får tak i alle dersom du for eksempel vil invitere til en sosial samling, som en after-work, å spille squash, eller litt Fortnite.</p>
          ...
          <article id="handbok-employment">
            ...
            <p>En ansettelse er en svært viktig investering for Kodeworks. De ansatte er ikke bare personer som vil bidra til et godt arbeidsmiljø, men de er og det produktet Kodeworks leverer. Det er derfor et stort fokus på å ansatte dyktige medarbeidere som søker og mestrer utfordringer. Det er de ansatte som utgjør Kodeworks.</p>
          </article>

          <article id="handbok-process-and-onboarding">
            <h2>Prosess og onboarding</h2>

            <p>I Kodeworks vil vi at du som nyansatt skal føle at prosessen fra tiden du har tatt kontakt med oss, til kontrakten er signert du har begynt å jobbe, har vært en god opplevelse.</p>
            <p>Til vanlig vil du som nyansatt bli fulgt opp av daglig leder under ansettelsen og påfølgende onboarding, som i hovedsak består av følgende tema:</p>

            <ul>
              <li>Jobbtilbud og signering av arbeidskontrakt.</li>
              <li>Bestilling av nødvendig utstyr, slik som arbeidsmaskin, mobiltelefon med tilhørende abonnement, samt annet tilleggsutstyr.</li>
              <li>Oppretting av nødvendige brukere i Google Workspace, Tripletex (regnskapssystem), og Werkz (timeføringssystem).</li>
              <li>Innmelding i selskapets pensjon- og forsikringsavtaler.</li>
              <li>Invitasjon til samhandlingsplattformer:
                <ul>
                  <li>Slack</li>
                  <li>GitHub</li>
                  <li>Discord</li>
          ...
          <article id="handbok-probation">
            ...
            <p>Som ny fulltidsansatt har du en prøvetid på 6 måneder fra kontraktsfestet oppstartsdato. Prøvetiden er gjensidig. Med dette menes at den er til både for deg som nyansatt og Kodeworks som selskap for å eventuelt avslutte arbeidsforholdet dersom omstendighetene ikke var som forventet. Under prøveperioden har man oppsigelsestid på 1 måned.</p>
            <p>Prøvetiden kan bli utvidet dersom du har vært borte under prøveperioden, som for eksempel grunnet sykdom eller foreldrepermisjon. Hovedregelen er at prøvetiden kan forlenges dersom det skyldes forhold som oppstår fra den ansattes side, ikke dersom arbeidsgiver har forhindret den ansatte fra å kunne arbeide. En slik forlengelse vil meddeles skriftlig innen utgangen av prøvetiden.</p>
          </article>
          ...
          <article id="handbok-resignation">
            ...
            <p>En oppsigelse skal sendes skriftlig. Oppsigelsestiden er gjensidig for både deg som ansatt og arbeidsgiver. Oppsigelsestiden er normalt 3 måneder, med unntak av prøveperioden da den er 1 måned. Oppsigelsestiden starter fra første dag måneden etter oppsigelsen ble sendt, med mindre annet er eksplisitt avtalt.</p>
            <p>Dersom du skal forlate Kodeworks vil du måtte returnere utstyr du har fått utlevert. Avhengig av hvor gammelt utstyret er og hvilken nytteverdi det har for Kodeworks vil du kunne kjøpe det ut etter gjeldende avskrivningsregler. Dette kan for eksempel være arbeidsmaskinen din eller en mobiltelefon. Kodeworks ønsker i utgangspunktet ikke å kreve tilbake utstyr som ikke enkelt kan benyttes av andre ansatte eller omgjøres til kapital.</p>
            <p>Dersom du er medeier i selskapet, må også aksjene dine selges tilbake til selskapet i henhold til aksjonæravtalen.</p>
          </article>
        </section>
      </section>
    </>

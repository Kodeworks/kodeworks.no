    ...
    <div className="privacy">
      <section className={`section section-hero section-text-center`}>
        <div className={`section-content`}>
          ...
          <p>Informasjon om vår behandling av personopplysninger er nærmere beskrevet i denne personvernerklæringen.</p>

          <p><a href="/legal/privacy/pdf/kodeworks-personvernerklaering-ekstern.pdf">Last ned en kopi av Personvernerklæringen(PDF)</a>.</p>
      ...
      <section className={`section`}>
        <ul className="list-plain privacy-list">
          ...
          <li>
            ...
            <p>Vi bruker databehandlere til å samle inn, lagre eller på annen måte behandle personopplysninger på våre vegne. I slike tilfeller har vi inngått avtaler for å ivareta informasjonssikkerheten i alle ledd av behandlingen.  Vi benytter oss av følgende databehandlere per i dag:</p>
            <ul>
          ...
          <li>
            ...
            <p>Du har rett til å kreve innsyn i, retting eller sletting av personopplysningene vi behandler om deg. Du har videre rett til å kreve begrenset behandling, rette innsigelse mot behandlingen og kreve rett til dataportabilitet. Du kan lese mer om innholdet i disse rettighetene på Datatilsynets nettside: <a href="https://www.datatilsynet.no">www.datatilsynet.no</a>.</p>

            <p>For å ta i bruk dine rettigheter må du sende din henvendelse til Kodeworks AS v/ Eirik Larsen. Vi vil svare på din henvendelse til oss så fort som mulig, og senest innen 30 dager.</p>

          </li>
          <li>
            <h2>Klager</h2>
            <p>Opplever du at vår behandling av personopplysninger ikke er i overensstemmelse med det vi har beskrevet her eller at vi på andre måter bryter personvernlovgivningen, kan du klage til Datatilsynet.</p>
            <p>Du finner informasjon om dine rettigheter og hvordan kontakte Datatilsynet på Datatilsynets nettsider: <a href="https://www.datatilsynet.no">www.datatilsynet.no</a>.</p>

          </li>
          <li>
            <h2>Endringer</h2>
            <p>Hvis det skulle skje endring av våre tjenester eller endringer i regelverket om behandling av personopplysninger, kan det medføre endringer i denne personvernerklæringen. Du vil alltid finne siste versjon på vår nettside.</p>

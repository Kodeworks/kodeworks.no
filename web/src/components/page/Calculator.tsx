...
export default function Calculator({ careerSchema }: Props) {
  ...
  function getSalary() {
    ...
    return careerSchema.salaryStpes![
      salaryLevel > 19 ? careerSchema.salaryStpes!.length - 1 : salaryLevel
    ];
  }
          ...
          <div className={`border-2 border-solid border-[#B6FF9E] gap-y-4 flex flex-col w-min`}>
            ...
            <div className="flex flex-col px-5 py-2">
              <div className="flex">
                ...
                >
                  <p>
                    Er summen av faster godene som du får som ansatt hos KodeWorks blant annet
                    Telefon, lapton, annet utstyr, kurs og konferanse, telefonabonnement, bredbånd
              ...
              <div className="flex">
                ...
                >
                  <p>
                    ...
                    {careerSchema.basicPensionAmount!.amount!}.
                  </p>
                </TooltipComponent>
              </div>
              <NumberWithSeperators

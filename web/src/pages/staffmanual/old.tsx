        ...
        <section className="handbook-content">
          ...
          <article id="handbok-betingelser">
            ...
            <ul>
              ...
              <li>
                I foreldrepermisjon dekker vi lønnen som er mellom det NAV betaler ut og opp til
                100% av Kodeworks-lønn i 49 uker, eller 80% av Kodeworks-lønn i 59 uker, avhengig av
                hvilken ordning man velger.
              </li>
            </ul>
